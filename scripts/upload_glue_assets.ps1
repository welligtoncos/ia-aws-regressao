...
Compress-Archive -Path "glue_bundle/train_pipeline.py","glue_bundle/preprocessor.py","glue_bundle/model.py","glue_bundle/catalog_sync.py" -DestinationPath $ZipPath -Force
